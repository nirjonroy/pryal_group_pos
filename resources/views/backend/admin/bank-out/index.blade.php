...
<!--########################################################################-->
    ...
    <h4 class="font-weight-bold py-3 mb-0">Bank Amount Out</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <a href="{{ route('bank-out.create') }}" class="btn btn-primary pull-right">Create</a>
                                    ...
                                    <div class="btn-group" id="hover-dropdown-demo">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @if(auth()->user()->hasRole('admin'))
                                             <a class="dropdown-item" href="{{ route('bank-in.edit',$item->id) }}">Edit</a>
                                            @endif
                                            @if(auth()->user()->can('bank-out.delete'))
