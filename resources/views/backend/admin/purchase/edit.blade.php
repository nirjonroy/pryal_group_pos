...
@section('page_title') | Purchase Update @endsection
@push('css')
<style>
    .red{color:red;}
    .gray{color:gray;}
...
<!--########################################################################-->
    ...
    <h4 class="font-weight-bold py-3 mb-0">Update Purchase</h4>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <select name="project_id"  class="form-control select2" required>
                        ...
                        <option  {{ $purchase->project_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }} ({{ $item->companies->name }})</option>
                        @endforeach
                    </select>
