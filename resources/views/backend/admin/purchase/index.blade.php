...
@section('page_title') | Purchase Index @endsection
@push('css')
...
<div class="container-fluid flex-grow-1 container-p-y" id="print">
    ...
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb no-print">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item no-print"><a href="{{ route('admin.purchase.create') }}"> Purchase Create </a></li>
        </ol>
    </div>
    <div class="row" >
        <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control" name="status" onchange="this.form.submit()">
                                    ...
                                    <option value="4" {{request()->status=='4' ?'selected':''}}>Partnership</option>
                ...
                <div class="card-datatable table-responsive" >
                    <table class="datatables-demo table table-striped table-bordered">
                        ...
                        <tbody>
                                ...
                                <td style="width:10%;" class="no-print">
                                    <div class="btn-group" id="hover-dropdown-demo">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" class="btn btn-success btn-info" href="{{ route('admin.purchase.show',$item->id) }}">
                                            ...
                                            @if(!auth()->user()->hasRole('admin') and ( date('Y-m-d') == date('Y-m-d', strtotime($item->created_at))))
                                                <a class="dropdown-item" href="{{ route('admin.purchase.edit',$item->id) }}">
                            ...
                            @endforeach
                            <tr>
                                <th colspan="6" class="text-right" >Page Summery =</th>
