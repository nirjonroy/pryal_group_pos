                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                   {{ number_format($supplier->stock_purchase->sum('total_price'),2) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <strong>
                                                        {{ number_format($supplier->purchaseStockpayment->sum('total_price'),2) }}
                                                    </strong>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <strong>
                                                       {{ number_format($supplier->stock_purchase->sum('total_price') - $supplier->purchaseStockpayment->sum('total_price'),2) }}
                                                    </strong>
                                                </td>
                                            </tr>
                                        </tbody>
                    ...
                    <div class="table-responsive mb-4">
                                ...
                                <table class="table table-striped table-bordered">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <th colspan="3" style="color:red" class="text-right"> Total=</th>
