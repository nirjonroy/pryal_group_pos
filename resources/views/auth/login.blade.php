...
<link rel="icon" type="image/x-icon" href="{{asset('backend/links/assets')}}/img/MS_Priyal_Trades.jpeg">
...
<div class="authentication-wrapper authentication-2 ui-bg-cover ui-bg-overlay-container px-4" style="background-image: url('{{asset('backend/links/assets')}}/img/bg.jpg');">
...
<img src="{{asset('backend/links/assets')}}/img/MS_Priyal_Trades.jpeg" alt="Brand Logo" class="img-fluid" style="width:50px; height:50px; border-radius:100px">
